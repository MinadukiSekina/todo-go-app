...
//
//	mockgen -source=app/usecases/todoUsecase.go -destination=app/mock/usecase/mockTodoUsecase.go
//
...
func (m *MockTodoUsecase) Close() error {
	m.ctrl.T.Helper()
...
func (mr *MockTodoUsecaseMockRecorder) Close() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Close", reflect.TypeOf((*MockTodoUsecase)(nil).Close))
}
